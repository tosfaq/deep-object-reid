...
def main():
    ...
    datasets = dict(
        ...
        voc=dict(
            roots=['multilabel_classification/mlc_voc_2007/train.json', 'mlc_voc_2007/val.json'],
        ...
        vg500=dict(
            roots=['multilabel_classification/VG500/train.json', 'VG500/val.json'],
        ...
        nus_wide=dict(
            roots=['multilabel_classification/nus_wide/train.json', 'nus_wide/val.json'],
