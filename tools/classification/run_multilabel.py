...
def main():
    ...
    datasets = dict(
        ...
        voc=dict(
            roots=['multilabel_classification/mlc_voc_2007/train.json', 'multilabel_classification/mlc_voc_2007/val.json'],
        ...
        vg500=dict(
            roots=['multilabel_classification/VG500/train.json', 'multilabel_classification/VG500/val.json'],
        ...
        nus_wide=dict(
            roots=['multilabel_classification/nus_wide/train.json', 'multilabel_classification/nus_wide/val.json'],
